...
(
    ...
    ProjectGrantAllocationRequestFundingSourceID int not null constraint FK_ProjectGrantAllocationRequestRequestFundingSource_ProjectGrantAllocationRequestFundingSourceID foreign key references dbo.ProjectGrantAllocationRequestFundingSource(ProjectGrantAllocationRequestFundingSourceID)
)
