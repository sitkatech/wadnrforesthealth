...
drop table dbo.ProjectSimpleLocationFixes

DROP TABLE IF EXISTS #projectsToDelete 
SELECT p.ProjectID INTO #projectsToDelete from dbo.Project as p join dbo.ProjectProgram as pp on p.ProjectID = pp.ProjectID where ProgramID = 1
