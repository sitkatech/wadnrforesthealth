...
insert into dbo.ReportTemplateModel
	(ReportTemplateModelID, ReportTemplateModelName, ReportTemplateModelDisplayName, ReportTemplateModelDescription)
select 1, 'Project', 'Project', 'Templates will be with the "Project" model.'