...
(86, N'PlannedDate', N'Planned Date', N'<p>The date on which project planning and design began. All projects should have a Planned Date and it may not be a date in the future. Contrast with &quot;Implementation Start Date.&quot; For more detailed information, see the definition for &quot;Stage&quot;.</p>'),
