...
(495, N'ExternalMapLayerUrl', 'Url', 'The external map web service URL (E.g https://hydro.nationalmap.gov/arcgis/rest/services/wbd/MapServer/3 (National 6-digit HUC boundaries).'),
...
(499, N'ExternalMapLayerDisplayOnProjectMap', 'Display on project maps?', 'When this option is set, the external map layer will appear on Project maps.'),
