...
(56, N'FundedAmount', N'Funded Amount', N'<p>The amount of funding, by fund source allocation, expended on a project for a specific year. To see the total amount of funding expended on a project, click on the specific project.</p>'),
...
(248, N'UnsecuredFunding', N'Unsecured Funding', N'<p>Funding that has been identified for a project but has not been acquired such as planned fund source applications.</p>'),
...
(283, N'FundSourceName', 'Fund Source Name', N'<p>The name of a fund source. Fund Source names should generally include a reference to 1) the location of the fund source, 2) the primary implementation activity, and 3) the fund source year</p>'),
(284, N'FundSourceShortName', 'Short Name', N'<p>The short hand name to reference a fund source</p>'),
(285, N'FundSourceStatus', 'Status', N'<p>The status of a fund source. This can be Active, Pending, Planned, or Closeout</p>'),
(286, N'FundSourceType', 'Type', N'<p>The type of fund source. This can either be Stand Alone, or CPG. </p>'),
(287, N'FundSourceNumber', 'Fund Source Number', N'<p>The fund source number. </p>'),
(288, N'CFDA', 'CFDA', N'<p>The CFDA code for a fund source. </p>'),
(289, N'TotalAwardAmount', 'Total Award Amount', N'<p>The total amount of money awarded by the fund source. This may include the sum of all associated fund source allocations. </p>'),
(290, N'FundSourceStartDate', 'Start Date', N'<p>The start date of the fund source. </p>'),
(291, N'FundSourceEndDate', 'End Date', N'<p>The end date of the fund source. </p>'),
(292, N'FundSourceNote', 'Fund Source Note', N'<p>Any additional important information about the fund source. </p>'),
...
(307, N'FundSourceAllocationNote', 'Fund Source Allocation Note', N'<p>Any additional important information about the fund source allocation.</p>'),
...
(321, N'FundSourceNoteInternal', 'Internal Fund Source Note', N'<p>Any additional important information about the fund source. These notes are only visible to internal users </p>'),
(322, N'FundSourceAllocationNoteInternal', 'Internal Fund Source Allocation Note', N'<p>Any additional important information about the fund source allocation. These notes are only visible to internal users </p>'),
...
(333, N'InvoiceLineItem', N'Invoice Line Item', N'<p>A line item on an invoice which includes an amount and the associated fund source allocation/fund source.</p>'),
