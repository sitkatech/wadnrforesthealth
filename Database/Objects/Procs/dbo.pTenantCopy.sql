...
as
	insert into dbo.TenantAttribute(TenantID, TaxonomyLevelID, DefaultBoundingBox, MinimumYear, TenantDisplayName, ToolDisplayName, ShowApplicationsToThePublic, RecaptchaPublicKey, RecaptchaPrivateKey)
	values
