...
CREATE TABLE [dbo].[GrantAllocationAwardLandownerCostShareLineItem](
	...
	[GrantAllocationAwardLandownerCostShareLineItemFootprintAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemChippingAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemPruningAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemThinningAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemMasticationAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemGrazingAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemLopAndScatterAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemBiomassRemovalAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemHandPileAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemBroadcastBurnAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemHandPileBurnAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemMachinePileBurnAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemOtherTreatmentAcres] [decimal](38, 10) NOT NULL,
	[GrantAllocationAwardLandownerCostShareLineItemSlashAcres] [decimal](38, 10) NOT NULL,
