...
GO
ALTER TABLE [dbo].[ProjectGrantAllocationRequestRequestFundingSource]  WITH CHECK ADD  CONSTRAINT [FK_ProjectGrantAllocationRequestRequestFundingSource_ProjectGrantAllocationRequestFundingSource_ProjectGrantAllocationRequestFun] FOREIGN KEY([ProjectGrantAllocationRequestFundingSourceID])
REFERENCES [dbo].[ProjectGrantAllocationRequestFundingSource] ([ProjectGrantAllocationRequestFundingSourceID])
GO
ALTER TABLE [dbo].[ProjectGrantAllocationRequestRequestFundingSource] CHECK CONSTRAINT [FK_ProjectGrantAllocationRequestRequestFundingSource_ProjectGrantAllocationRequestFundingSource_ProjectGrantAllocationRequestFun]