...
CREATE TABLE [dbo].[GrantAllocationExpenditureJsonStage](
	[GrantAllocationExpenditureJsonStageID] [int] IDENTITY(1,1) NOT NULL,
	[Biennium] [int] NULL,
	[FiscalMo] [int] NULL,
 ...
 CONSTRAINT [PK_GrantAllocationExpenditureJsonStage_GrantAllocationExpenditureJsonStageID] PRIMARY KEY CLUSTERED 
(
	[GrantAllocationExpenditureJsonStageID] ASC
