...
GO
ALTER TABLE [dbo].[InvoiceLineItem]  WITH CHECK ADD  CONSTRAINT [CK_InvoiceLineItem_CostTypeValues] CHECK  (([CostTypeID]=(1) OR [CostTypeID]=(2) OR [CostTypeID]=(3) OR [CostTypeID]=(4) OR [CostTypeID]=(5) OR [CostTypeID]=(7) OR [CostTypeID]=(8)))
GO
