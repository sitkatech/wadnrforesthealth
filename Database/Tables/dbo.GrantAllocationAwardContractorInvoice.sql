...
CREATE TABLE [dbo].[GrantAllocationAwardContractorInvoice](
	...
	[GrantAllocationAwardContractorInvoiceGrappleHours] [decimal](18, 0) NULL,
	[GrantAllocationAwardContractorInvoiceGrappleRate] [money] NULL,
	[GrantAllocationAwardContractorInvoiceMasticationHours] [decimal](18, 0) NULL,
	[GrantAllocationAwardContractorInvoiceMasticationRate] [money] NULL,
	[GrantAllocationAwardContractorInvoiceTotal] [money] NULL,
	[GrantAllocationAwardContractorInvoiceTaxRate] [decimal](18, 0) NULL,
	[GrantAllocationAwardContractorInvoiceAcresReported] [decimal](18, 0) NULL,
