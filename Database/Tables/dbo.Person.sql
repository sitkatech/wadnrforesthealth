...
CREATE TABLE [dbo].[Person](
	...
	[AllowedAuthenticatorID] [int] NOT NULL,
...
GO
ALTER TABLE [dbo].[Person]  WITH CHECK ADD  CONSTRAINT [FK_Person_Authenticator_AllowedAuthenticatorID_AuthenticatorID] FOREIGN KEY([AllowedAuthenticatorID])
REFERENCES [dbo].[Authenticator] ([AuthenticatorID])
GO
ALTER TABLE [dbo].[Person] CHECK CONSTRAINT [FK_Person_Authenticator_AllowedAuthenticatorID_AuthenticatorID]
GO
