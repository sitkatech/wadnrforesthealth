...
namespace ProjectFirma.Web.Controllers
{
    public class ProjectUpdateController : FirmaBaseController
    {
        ...
        {          
            ...
            var projectLocationSummaryViewData = new ProjectLocationSummaryViewData(projectUpdate, projectLocationSummaryMapInitJson, new List<PriorityLandscape>(), new List<Region>(), string.Empty, string.Empty);
            var updateStatus = GetUpdateStatus(projectUpdateBatch);
        ...
        private ViewResult ViewPriorityLandscapes(Project project, ProjectUpdateBatch projectUpdateBatch, PriorityLandscapesViewModel viewModel)
        {
            ...
            var noPriorityLandscapesExplanation = projectUpdateBatch.NoPriorityLandscapesExplanation;
            var projectLocationSummaryViewData = new ProjectLocationSummaryViewData(projectUpdate, projectLocationSummaryMapInitJson, priorityLandscapes, new List<Region>(), string.Empty, noPriorityLandscapesExplanation);
            var updateStatus = GetUpdateStatus(projectUpdateBatch);
