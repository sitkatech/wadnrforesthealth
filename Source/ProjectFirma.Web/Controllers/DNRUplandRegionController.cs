...
namespace ProjectFirma.Web.Controllers
{
    public class DNRUplandRegionController : FirmaBaseController
    {
        ...
        public GridJsonNetJObjectResult<GrantAllocation> GrantAllocationsGridJsonData(DNRUplandRegionPrimaryKey dnrUplandRegionPrimaryKey)
        {
            ...
            var grantAllocations = dnrUplandRegionPrimaryKey.EntityObject.GetAssociatedGrantAllocations(CurrentPerson).Where(x=>x.GrantModification.Grant.GrantStatus.GrantStatusID == GrantStatus.Active.GrantStatusID).ToList();
