...
namespace ProjectFirma.Web.Controllers
{
    public class ProjectCountyController : FirmaBaseController
    {
        ...
        public PartialViewResult EditProject(ProjectPrimaryKey projectPrimaryKey)
        {
            var project = projectPrimaryKey.EntityObject;
            var regionIDs = project.ProjectRegions.Select(x => x.CountyID).ToList();
        ...
        public ActionResult EditProjectRegions(ProjectPrimaryKey projectPrimaryKey, EditProjectRegionsViewModel viewModel)
        {
            ...
            project.NoRegionsExplanation = !string.IsNullOrWhiteSpace(viewModel.NoCountiesExplanation) ? viewModel.NoCountiesExplanation : null;
        ...
        public JsonResult FindRegionByName(string term)
        {
            ...
            return Json(HttpRequestStorage.DatabaseEntities.Counties
                ...
                .Select(x => new {RegionName = x.CountyName, RegionID = x.CountyID}).ToList(), JsonRequestBehavior.AllowGet);
        }
