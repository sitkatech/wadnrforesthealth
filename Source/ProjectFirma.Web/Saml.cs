...
namespace Saml
{
    ...
    public class Response
    {
        ...
        {
            var node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name='groups']/saml:AttributeValue", _xmlNameSpaceManager);
            return node?.InnerText;
        }
