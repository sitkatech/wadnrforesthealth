...
{
    public class EditGrantAllocationLineItemsViewModel : FormViewModel, IValidatableObject
    {
        ...
        /// </summary>
        public EditGrantAllocationLineItemsViewModel()
        {
        }

        public EditGrantAllocationLineItemsViewModel(Models.GrantAllocation grantAllocation)
        {
