/*-----------------------------------------------------------------------
<copyright file="GrantAllocationExpendituresGridSpec.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
namespace ProjectFirma.Web.Views.GrantAllocation
{
    public class GrantAllocationExpendituresGridSpec : GridSpec<GrantAllocationExpenditure>
    {
        ...
        {
            Add(Models.FieldDefinition.CostType.ToGridHeaderString(), gae => gae.CostType?.CostTypeDisplayName, 150, DhtmlxGridColumnFilterType.Text);
