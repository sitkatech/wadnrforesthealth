...
namespace ProjectFirma.Web.Views.User
{
    public class IndexGridSpec : GridSpec<Person>
    {
        public IndexGridSpec(Person currentPerson)
        {
            ...
            Add($"{Models.FieldDefinition.Organization.GetFieldDefinitionLabelPluralized()}", a => GetOrganizationShortNameUrlJson(a), 200, AgGridColumnFilterType.HtmlLinkJson);
        ...
        private static string GetOrganizationShortNameUrlJson(Person person)
        {
            ...
            return $"{{ \"link\":\"{person.Organization.GetDetailUrl()}\",\"displayText\":\"{person.Organization.OrganizationShortName ?? person.Organization.OrganizationName}\" }}"; 
