...
namespace ProjectFirma.Web.Views.Project
{
    public class ProjectIndexGridSpec : GridSpec<Models.Project>
    {
        public ProjectIndexGridSpec(Person currentPerson)
        {
            ...
            Add(Models.FieldDefinition.ProjectTotalCompletedFootprintAcres.ToGridHeaderString(), x => x.TotalCompletedFootprintAcres.ToString(CultureInfo.CurrentUICulture), 100, DhtmlxGridColumnFilterType.FormattedNumeric);
