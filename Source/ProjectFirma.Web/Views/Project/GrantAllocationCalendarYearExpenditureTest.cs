/*-----------------------------------------------------------------------
<copyright file="GrantAllocationCalendarYearExpenditureTest.cs" company="Tahoe Regional Planning Agency and Environmental Science Associates">
...
namespace ProjectFirma.Web.Views.Project
{
    ...
    public class GrantAllocationCalendarYearExpenditureTest
    {
        ...
        public void CreateFromGrantAllocationsAndCalendarYearsTest()
        {
            ...
            Approvals.Verify(JsonConvert.SerializeObject(result.Select(x => new { x.GrantAllocationName, x.CalendarYearExpenditure }), Formatting.Indented));
        }
