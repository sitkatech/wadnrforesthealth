...
namespace ProjectFirma.Web.Views.Reports
{
    public class IndexViewData : FirmaViewData
    {
        ...
        {
            GridSpec = new ReportTemplateGridSpec(new ReportTemplateViewListFeature().HasPermissionByPerson(currentPerson))
            {
            ...
            HasManageReportTemplatePermissions = new ReportTemplateManageFeature().HasPermissionByPerson(currentPerson);
