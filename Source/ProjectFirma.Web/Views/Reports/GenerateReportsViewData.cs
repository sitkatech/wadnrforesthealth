...
namespace ProjectFirma.Web.Views.Reports
{
    public class GenerateReportsViewData : FirmaViewData
    {
        ...
        public GenerateReportsViewData(Person currentPerson, List<Models.Project> projectsList,  IEnumerable<SelectListItem> reportTemplateSelectListItems) : base(currentPerson)
        {
