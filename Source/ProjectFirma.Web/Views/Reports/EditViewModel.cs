...
namespace ProjectFirma.Web.Views.Reports
{
    public class EditViewModel : FormViewModel, IValidatableObject
    {
        ...
        public void UpdateModel(ReportTemplate reportTemplate, FileResource fileResourceInfo,
            Person currentPerson, DatabaseEntities databaseEntities)
        {
            // updating parameters
            reportTemplate.DisplayName = DisplayName;
            reportTemplate.Description = Description;
            reportTemplate.FileResource = fileResourceInfo;
