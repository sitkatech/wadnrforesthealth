...
namespace ProjectFirma.Web.Views
{
    public abstract class FirmaViewData
    {
        ...
        private static LtInfoMenuItem BuildProjectsMenu(Person currentPerson)
        {
            ...
            projectsMenu.AddMenuItem(LtInfoMenuItem.MakeItem(new SitkaRoute<InteractionEventController>(iec => iec.Index()), currentPerson, $"All {Models.FieldDefinition.InteractionEvent.GetFieldDefinitionLabelPluralized()}", "Group5"));
            return projectsMenu;
        }
