...
namespace ProjectFirma.Web.Views.Grant
{
    public class GrantAllocationBudgetLineItemGridSpec : GridSpec<Models.GrantAllocationBudgetLineItemForGrid>
    {
        public GrantAllocationBudgetLineItemGridSpec(Models.Person currentPerson)
        {
            ...
            Add(Models.FieldDefinition.GrantModificationName.ToGridHeaderString(), x => x.GrantModification.GetGrantModificationNameAsUrl(), 30, DhtmlxGridColumnFilterType.SelectFilterHtmlStrict);
            Add(Models.FieldDefinition.GrantAllocationName.ToGridHeaderString(), x => UrlTemplate.MakeHrefString(x.GrantAllocation.GetDetailUrl(), x.GrantAllocation.GrantAllocationName), 250,DhtmlxGridColumnFilterType.Text);
