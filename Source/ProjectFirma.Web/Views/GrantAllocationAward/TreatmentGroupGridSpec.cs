...
namespace ProjectFirma.Web.Views.GrantAllocationAward
{
    public class TreatmentGroupGridSpec : GridSpec<Models.TreatmentGroup>
    {
        public TreatmentGroupGridSpec(Person currentPerson, Models.Project projectToCreateNewTreatments)
        {
            ...
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareChippingAcres.GetFieldDefinitionLabel(), a => a.Treatments.Where(x => x.TreatmentDetailedActivityType == TreatmentDetailedActivityType.Chipping).Sum(x => x.TreatmentTreatedAcres) ?? 0, 75, DhtmlxGridColumnFormatType.Decimal, DhtmlxGridColumnAggregationType.Total);
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostSharePruningAcres.GetFieldDefinitionLabel(), a => a.Treatments.Where(x => x.TreatmentDetailedActivityType == TreatmentDetailedActivityType.Pruning).Sum(x => x.TreatmentTreatedAcres) ?? 0, 75, DhtmlxGridColumnFormatType.Decimal, DhtmlxGridColumnAggregationType.Total);
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareThinningAcres.GetFieldDefinitionLabel(), a => a.Treatments.Where(x => x.TreatmentDetailedActivityType == TreatmentDetailedActivityType.Thinning).Sum(x => x.TreatmentTreatedAcres) ?? 0, 75, DhtmlxGridColumnFormatType.Decimal, DhtmlxGridColumnAggregationType.Total);
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareSlashAcres.GetFieldDefinitionLabel(), a => a.Treatments.Where(x => x.TreatmentDetailedActivityType == TreatmentDetailedActivityType.Slash).Sum(x => x.TreatmentTreatedAcres) ?? 0, 75, DhtmlxGridColumnFormatType.Decimal, DhtmlxGridColumnAggregationType.Total);
            ...
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareGrazingAcres.GetFieldDefinitionLabel(), a => a.Treatments.Where(x => x.TreatmentDetailedActivityType == TreatmentDetailedActivityType.Grazing).Sum(x => x.TreatmentTreatedAcres) ?? 0, 75, DhtmlxGridColumnFormatType.Decimal, DhtmlxGridColumnAggregationType.Total);
            ...
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareHandPileAcres.GetFieldDefinitionLabel(), a => a.Treatments.Where(x => x.TreatmentDetailedActivityType == TreatmentDetailedActivityType.HandPile).Sum(x => x.TreatmentTreatedAcres) ?? 0, 75, DhtmlxGridColumnFormatType.Decimal, DhtmlxGridColumnAggregationType.Total);
            ...
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareOtherTreatmentAcres.GetFieldDefinitionLabel(), a => a.Treatments.Where(x => x.TreatmentDetailedActivityType == TreatmentDetailedActivityType.Other).Sum(x => x.TreatmentTreatedAcres) ?? 0, 75, DhtmlxGridColumnFormatType.Decimal, DhtmlxGridColumnAggregationType.Total);
