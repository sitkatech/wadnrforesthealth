/*-----------------------------------------------------------------------
<copyright file="EditContractorInvoiceViewModel.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
{
    public class EditContractorInvoiceViewModel : FormViewModel
    {
        ...
        [FieldDefinitionDisplay(FieldDefinitionEnum.GrantAllocationAwardContractorInvoiceTargetTotalAcreage)]
        public int ContractorInvoiceTargetTotalAcreage { get; set; }

        /// <summary>
        /// Needed by the ModelBinder
        /// </summary>
        public EditContractorInvoiceViewModel()
        {
        }
