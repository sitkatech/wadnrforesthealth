    ...
    .controller("EditProjectPriorityLandscapesController",
        function ($scope, angularModelAndViewData) {
            ...
            function onMapClick(event) {
                var priorityLandscapeMapSericeLayerName = $scope.AngularViewData.PriorityLandscapeMapServiceLayerName,
                    mapServiceUrl = $scope.AngularViewData.MapServiceUrl;

                if (!priorityLandscapeMapSericeLayerName || !mapServiceUrl)
                    return;
                ...
                var parameters = L.Util.extend($scope.firmaMap.wfsParams,
                    {
                        typeName: priorityLandscapeMapSericeLayerName,
            ...
            function updateSelectedPriorityLandscapeLayer() {
                ...
                var wmsParameters = L.Util.extend(
                    {
                        layers: $scope.AngularViewData.PriorityLandscapeMapSericeLayerName,
