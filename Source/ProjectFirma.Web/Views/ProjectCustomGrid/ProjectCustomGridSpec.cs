...
namespace ProjectFirma.Web.Views.ProjectCustomGrid
{
    public class ProjectCustomGridSpec : GridSpec<ProjectFirmaModels.Models.Project>
    {
            ...
            , List<int> sitkaAdminPersonIDs)
        {
            ...
            switch (projectCustomGridConfiguration.ProjectCustomGridColumn.ToEnum)
            {
                ...
                case ProjectCustomGridColumnEnum.ProjectPrimaryContactEmail:
                    var userHasEmailViewingPermissions = new LoggedInAndNotUnassignedRoleUnclassifiedFeature().HasPermissionByPerson(currentFirmaSession);
        ...
        public ProjectCustomGridSpec(Person currentPerson,
            List<ProjectCustomGridConfiguration> projectCustomGridConfigurations,
            ProjectCustomGridTypeEnum projectCustomGridTypeEnum,
            Dictionary<int, vProjectDetail> projectDetailsDictionary): this(currentPerson, projectCustomGridConfigurations, projectCustomGridTypeEnum, projectDetailsDictionary, true)
        {
        }
        ...
        {
            bool userHasTagManagePermissions = new FirmaAdminFeature().HasPermissionByPerson(currentPerson);
            bool userHasDeletePermissionsAndShouldShowColumn = new ProjectDeleteFeature().HasPermissionByPerson(currentPerson) && shouldShowDeleteColumn;
            bool userHasEditProjectAsAdminPermissions = new ProjectEditAsAdminFeature().HasPermissionByPerson(currentPerson);
            bool userHasReportDownloadPermissions = new ReportTemplateGenerateReportsFeature().HasPermissionByPerson(currentPerson);
            ...
            bool hasProjectApprovalPermissionBySession =
                new ProjectApproveFeature().HasPermissionByPerson(currentPerson);
            ...
            AddConfiguredFields(currentPerson
