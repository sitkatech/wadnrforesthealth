...
{
    public class PriorityAreasViewData : ProjectCreateViewData
    {
        ...
        public PriorityAreasViewData(Person currentPerson,
            ...
            EditProjectPriorityAreasViewData editProjectPriorityAreasViewData) : base(currentPerson, project, ProjectCreateSection.PriorityAreas.ProjectCreateSectionDisplayName, proposalSectionsStatus)
        {
