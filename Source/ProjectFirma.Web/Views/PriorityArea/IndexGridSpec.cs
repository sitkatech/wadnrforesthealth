...
{
    public class IndexGridSpec : GridSpec<Models.PriorityArea>
    {
        public IndexGridSpec(Person person)
        {
            Add("PriorityArea", a => UrlTemplate.MakeHrefString(a.GetDetailUrl(), a.PriorityAreaName), 300, DhtmlxGridColumnFilterType.Html);
