...
namespace ProjectFirma.Web.Views.Map
{
    public class ProjectLocationsMapInitJson : MapInitJson
    {
        ...
        public ProjectLocationsMapInitJson(LayerGeoJson projectLocationsLayerGeoJson, ProjectMapCustomization customization, string mapDivID)
            : base(mapDivID, DefaultZoomLevel, GetAllGeospatialAreaMapLayers(LayerInitialVisibility.Hide), MapInitJson.GetExternalMapLayersForProjectMap(), BoundingBox.MakeNewDefaultBoundingBox())
        {
