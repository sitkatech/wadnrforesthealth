...
namespace ProjectFirma.Web.Views.GrantAllocationAwardLandownerCostShareLineItem
{
    public class LandownerCostShareIndexGridSpec : GridSpec<Models.GrantAllocationAwardLandownerCostShareLineItem>
    {
        public LandownerCostShareIndexGridSpec(Person currentPerson)
        {
            ...
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareStartDate.GetFieldDefinitionLabel(), a => a.Treatments.FirstOrDefault()?.TreatmentStartDate ?? DateTime.MinValue, 125, DhtmlxGridColumnFormatType.Date);
            Add(Models.FieldDefinition.GrantAllocationAwardLandownerCostShareEndDate.GetFieldDefinitionLabel(), a => a.Treatments.FirstOrDefault()?.TreatmentEndDate ?? DateTime.MinValue, 125, DhtmlxGridColumnFormatType.Date);
