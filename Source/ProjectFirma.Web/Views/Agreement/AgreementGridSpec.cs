...
namespace ProjectFirma.Web.Views.Agreement
{
    public class AgreementGridSpec : GridSpec<Models.Agreement>
    {
        ...
        public AgreementGridSpec(Models.Person currentPerson, bool agreementFileExistsOnAtLeastOne, bool showDeleteColumn, bool showCreateButton)
        {
            ...
            Add(Models.FieldDefinition.GrantAllocation.ToGridHeaderString(), x => x.GetListOfGrantHrefs() , 130, DhtmlxGridColumnFilterType.Html);
            ...
            Add(Models.FieldDefinition.ProjectCode.ToGridHeaderString(), x => x.ProgramIndexProjectCodes.ToDistinctOrderedCsvList(), 90, DhtmlxGridColumnFilterType.Text);
        }
