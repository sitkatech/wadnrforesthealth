...
{
    // Table [dbo].[GrantAllocationExpenditureJsonStage] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[dbo].[GrantAllocationExpenditureJsonStage]")]
    public partial class GrantAllocationExpenditureJsonStage : IHavePrimaryKey, ICanDeleteFull
    {
        /// <summary>
        /// Default Constructor; only used by EF
        /// </summary>
        protected GrantAllocationExpenditureJsonStage()
        {
        ...
        /// </summary>
        public static GrantAllocationExpenditureJsonStage CreateNewBlank()
        {
            return new GrantAllocationExpenditureJsonStage();
        }
        ...
        /// </summary>
        public static readonly List<string> DependentEntityTypeNames = new List<string> {typeof(GrantAllocationExpenditureJsonStage).Name};
        ...
        {
            dbContext.GrantAllocationExpenditureJsonStages.Remove(this);
        }
        ...
        [Key]
        public int GrantAllocationExpenditureJsonStageID { get; set; }
        ...
        [NotMapped]
        public int PrimaryKey { get { return GrantAllocationExpenditureJsonStageID; } set { GrantAllocationExpenditureJsonStageID = value; } }
