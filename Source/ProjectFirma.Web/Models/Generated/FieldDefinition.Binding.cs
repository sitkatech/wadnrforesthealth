...
namespace ProjectFirma.Web.Models
{
    ...
    public partial class FieldDefinitionUpdatesFromImport : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionUpdatesFromImport Instance = new FieldDefinitionUpdatesFromImport(480, @"UpdatesFromImport", @"Updates From Import", @"<p>Projects can be updated via the bulk-import process. They can be blocked from updating in this way.</p>");
    }
}