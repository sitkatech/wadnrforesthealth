...
namespace ProjectFirma.Web.Models
{
    ...
    public enum FieldDefinitionEnum
    {
        ...
        ExternalMapLayer = 480,
        ExternalMapLayerDisplayName = 481,
        ExternalMapLayerUrl = 482,
        ExternalMapLayerDescription = 483,
        ExternalMapLayerFeatureNameField = 484,
        ExternalMapLayerDisplayOnPriorityLandscape = 485,
        ExternalMapLayerDisplayOnProjectMap = 486,
        ExternalMapLayerDisplayOnAllOthers = 487,
        ExternalMapLayerIsATiledMapService = 488,
        ExternalMapLayerIsActive = 489
    }
    ...
    public partial class FieldDefinitionExternalMapLayerDisplayName : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionExternalMapLayerDisplayName Instance = new FieldDefinitionExternalMapLayerDisplayName(481, @"ExternalMapLayerDisplayName", @"Display Name", @"The layer display name will appear in map legends and popups.");
    }
    ...
    public partial class FieldDefinitionExternalMapLayerUrl : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionExternalMapLayerUrl Instance = new FieldDefinitionExternalMapLayerUrl(482, @"ExternalMapLayerUrl", @"Url", @"The external map web service URL (E.g https://hydro.nationalmap.gov/arcgis/rest/services/wbd/MapServer/3 (National 6-digit HUC boundaries).");
    }
    ...
    public partial class FieldDefinitionExternalMapLayerDescription : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionExternalMapLayerDescription Instance = new FieldDefinitionExternalMapLayerDescription(483, @"ExternalMapLayerDescription", @"Internal Layer Description", @"Add helpful background information for other administrators (E.g who to contact if there is a problem with this external map service in the future).");
    }
    ...
    public partial class FieldDefinitionExternalMapLayerFeatureNameField : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionExternalMapLayerFeatureNameField Instance = new FieldDefinitionExternalMapLayerFeatureNameField(484, @"ExternalMapLayerFeatureNameField", @"Field to use as source for feature names", @"This setting will populate the map pop-ups with names from the feature service. This is field is case-sensitive (E.g. Name or NAME) and must match a field in the web service. Please leave this field blank for tile services since pop-ups are not supported.");
    }
    ...
    public partial class FieldDefinitionExternalMapLayerDisplayOnProjectMap : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionExternalMapLayerDisplayOnProjectMap Instance = new FieldDefinitionExternalMapLayerDisplayOnProjectMap(486, @"ExternalMapLayerDisplayOnProjectMap", @"Display on project maps?", @"When this option is set, the external map layer will appear on Project maps.");
    }
    ...
    public partial class FieldDefinitionExternalMapLayerDisplayOnAllOthers : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionExternalMapLayerDisplayOnAllOthers Instance = new FieldDefinitionExternalMapLayerDisplayOnAllOthers(487, @"ExternalMapLayerDisplayOnAllOthers", @"Display on All Other Maps?", @"When this option is set, the external map layer will appear on maps throughout the system, except for the Priority Landscape and Project maps (which have their own settings).");
    }
    ...
    public partial class FieldDefinitionExternalMapLayerIsATiledMapService : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionExternalMapLayerIsATiledMapService Instance = new FieldDefinitionExternalMapLayerIsATiledMapService(488, @"ExternalMapLayerIsATiledMapService", @"Is a Tiled Map Service", @"Please turn on this setting if the external map layer is a tiled layer (raster). Note: Pop-ups will not appear on maps for tiled layers.");
    }
