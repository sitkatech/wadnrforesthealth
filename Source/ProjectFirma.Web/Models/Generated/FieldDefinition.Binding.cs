...
namespace ProjectFirma.Web.Models
{
    public abstract partial class FieldDefinition : IHavePrimaryKey
    {
        ...
        public static readonly FieldDefinitionPayAmount PayAmount = FieldDefinitionPayAmount.Instance;
        ...
        public static FieldDefinition ToType(FieldDefinitionEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                case FieldDefinitionEnum.Password:
                    return Password;
                case FieldDefinitionEnum.PayAmount:
                    return PayAmount;
    ...
    public partial class FieldDefinitionPayAmount : FieldDefinition
    {
        private FieldDefinitionPayAmount(int fieldDefinitionID, string fieldDefinitionName, string fieldDefinitionDisplayName, string defaultDefinition) : base(fieldDefinitionID, fieldDefinitionName, fieldDefinitionDisplayName, defaultDefinition) {}
        public static readonly FieldDefinitionPayAmount Instance = new FieldDefinitionPayAmount(318, @"PayAmount", @"Pay Amount", @"The total amount of funding requested by a given invoice");
    }
