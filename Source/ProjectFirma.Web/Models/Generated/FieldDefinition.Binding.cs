...
namespace ProjectFirma.Web.Models
{
    public abstract partial class FieldDefinition : IHavePrimaryKey
    {
        ...
        public static readonly FieldDefinitionInteractionEventStaff InteractionEventStaff = FieldDefinitionInteractionEventStaff.Instance;
        ...
        public static FieldDefinition ToType(FieldDefinitionEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                case FieldDefinitionEnum.InteractionEventStaff:
                    return InteractionEventStaff;
    ...
    public partial class FieldDefinitionInvoiceLineItem : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionInvoiceLineItem Instance = new FieldDefinitionInvoiceLineItem(333, @"InvoiceLineItem", @"Invoice Line Item", @"<p>A line item on an invoice which includes an amount and the associated funding source/grant.</p>");
    }
    ...
    public partial class FieldDefinitionInteractionEventStaff : FieldDefinition
    {
        private FieldDefinitionInteractionEventStaff(int fieldDefinitionID, string fieldDefinitionName, string fieldDefinitionDisplayName, string defaultDefinition) : base(fieldDefinitionID, fieldDefinitionName, fieldDefinitionDisplayName, defaultDefinition) {}
        public static readonly FieldDefinitionInteractionEventStaff Instance = new FieldDefinitionInteractionEventStaff(336, @"InteractionEventStaff", @"Interaction/Event Staff", @"<p>Placeholder definition for Interaction/Event Staff description.</p>");
    }
}