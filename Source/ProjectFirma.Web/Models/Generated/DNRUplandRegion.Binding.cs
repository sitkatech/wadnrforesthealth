...
namespace ProjectFirma.Web.Models
{
    ...
    public partial class DNRUplandRegion : IHavePrimaryKey, ICanDeleteFull
    {
        ...
        /// </summary>
        public DNRUplandRegion(int dNRUplandRegionID, string dNRUplandRegionAbbrev, string dNRUplandRegionName, DbGeometry dNRUplandRegionLocation, string regionAddress, string regionCity, string regionState, string regionZip, string regionPhone, string regionEmail, int? dNRUplandRegionCoordinator) : this()
        {
            ...
            this.DNRUplandRegionCoordinator = dNRUplandRegionCoordinator;
        }
        ...
        public int? DNRUplandRegionCoordinator { get; set; }
        [NotMapped]
