...
{
    // Table [dbo].[ProjectTag] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[dbo].[ProjectTag]")]
    public partial class ProjectTag : IHavePrimaryKey, ICanDeleteFull
    {
        /// <summary>
        ...
        {
            dbContext.ProjectTags.Remove(this);
        }
