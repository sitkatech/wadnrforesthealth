...
namespace ProjectFirma.Web.Models
{
    public static partial class DatabaseContextExtensions
    {
        ...
        {
            if (projectUpdate.GetCompletionAnnum() < projectUpdate.GetImplementationStartYear()) return new List<int>();
            if (projectUpdate.GetCompletionAnnum() < projectUpdate.PlannedDate.GetValueOrDefault().Year) return new List<int>();
