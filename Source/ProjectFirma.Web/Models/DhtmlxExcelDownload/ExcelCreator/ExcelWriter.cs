...
namespace ProjectFirma.Web.Models.DhtmlxExcelDownload.ExcelCreator
{
    public class ExcelWriter
    {
        ...
        protected ExcelBorder getBorder()
        {
            ...
            border.BottomStyle = ExcelBorderStyleValues.Thin;
            border.BottomColor = LineColor;
            border.LeftStyle = ExcelBorderStyleValues.Thin;
            border.LeftColor = LineColor;
            border.RightStyle = ExcelBorderStyleValues.Thin;
            border.RightColor = LineColor;
            border.TopStyle = ExcelBorderStyleValues.Thin;
