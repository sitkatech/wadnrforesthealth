...
namespace ProjectFirma.Web.Models
{
    public static class GrantAllocationModelExtensions
    {
        ...
        public static readonly UrlTemplate<int> LineItemEditUrlTemplate = new UrlTemplate<int>(SitkaRoute<GrantAllocationController>.BuildUrlFromExpression(t => t.EditLineItems(UrlTemplate.Parameter1Int)));
        public static string GetLineItemEditUrl(this GrantAllocation grantAllocation)
        {
            return LineItemEditUrlTemplate.ParameterReplace(grantAllocation.GrantAllocationID);
        }
