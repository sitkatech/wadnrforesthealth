...
namespace ProjectFirma.Web.Models
{
    ...
    public class ProjectUpdateBatchTest
    {
        ...
        public void GetProjectUpdateStartToCompletionYearRangeTest()
        {
            ...
            Assert.That(projectUpdateBatch.ProjectUpdate.CompletionYear.HasValue, Is.False, $"Precondition: {FieldDefinition.Project.GetFieldDefinitionLabel()} update record has no completion year");
            AssertYearRangeForPerformanceMeasuresCorrect(projectUpdateBatch, currentYear, currentYear);
        ...
        public void GetProjectUpdatePlanningDesignStartToCompletionYearRangeTest()
        {
            ...
            projectUpdate.PlannedDate = new DateTime(currentYear - 1, 1, 1);
            projectUpdate.CompletionYear = currentYear - 1;
            AssertYearRangeForExpendituresCorrect(projectUpdateBatch, projectUpdate.PlannedDate.GetValueOrDefault().Year, projectUpdate.CompletionYear.Value);
        ...
        public void GetProjectUpdatePlanningDesignStartToCompletionYearRangeForProjectBudgetsTest()
        {
            ...
            projectUpdate.PlannedDate = new DateTime(currentYear - 2, 1, 1);
            projectUpdate.CompletionYear = currentYear - 1;
            AssertYearRangeForBudgetsCorrect(projectUpdateBatch, projectUpdate.PlannedDate.GetValueOrDefault().Year, projectUpdate.CompletionYear.Value);
        ...
        public void ValidateExpendituresAndForceValidationTest()
        {
            ...
            FirmaDateUtilities.GetRangeOfYears(projectUpdate.PlannedDate.GetValueOrDefault().Year, projectUpdate.CompletionYear.Value)
        ...
        public void ValidatePerformanceMeasuresAndForceValidationTest()
        {
            ...
            // fill in the other years missing
            FirmaDateUtilities.GetRangeOfYears(projectUpdate.GetImplementationStartYear().Value, projectUpdate.CompletionYear.Value)
