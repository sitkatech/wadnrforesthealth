...
namespace ProjectFirma.Web.Models
{
    public static class ProjectWizardComponents
    {
        ...
        public static readonly HtmlString RequiredInfoOkSubmitReadyIcon = BootstrapHtmlHelpers.MakeGlyphIcon("glyphicon-ok", "Required information has been provided (ready to submit)");
