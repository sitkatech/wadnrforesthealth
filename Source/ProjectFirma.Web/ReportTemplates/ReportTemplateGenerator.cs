...
namespace ProjectFirma.Web.ReportTemplates
{
    public class ReportTemplateGenerator
    {
        ...
        {
            var fileName = new FileInfo($"{FullTemplateTempDirectory}{ReportTemplateUniqueIdentifier}-{ReportTemplate.FileResource.OriginalCompleteFileName}");
        ...
        {
            var fileName = new FileInfo($"{FullTemplateTempDirectory}{ReportTemplateUniqueIdentifier}-generated-{ReportTemplate.FileResource.OriginalCompleteFileName}");
            fileName.Directory.Create();
            return fileName.FullName;
        }
