...
namespace ProjectFirma.Web.ReportTemplates.Models
{
    public class ReportTemplateProjectExpectedPerformanceMeasureModel : ReportTemplateBaseModel
    {
        ...
        public ReportTemplateProjectExpectedPerformanceMeasureModel(PerformanceMeasureExpected performanceMeasureExpected)
        {
            ...
            var performanceMeasureSubcategoryOptionName = performanceMeasureExpected.PerformanceMeasureExpectedSubcategoryOptions?.FirstOrDefault(x => x.PerformanceMeasureExpectedID == performanceMeasureExpected.PerformanceMeasureExpectedID)?.PerformanceMeasureSubcategoryOptionName ?? String.Empty;
