...
namespace ProjectFirma.Web.ReportTemplates.Models
{
    public class ReportTemplateProjectReportedPerformanceMeasureModel : ReportTemplateBaseModel
    {
        ...
        public ReportTemplateProjectReportedPerformanceMeasureModel(PerformanceMeasureActual performanceMeasureActual)
        {
            ...
            Year = performanceMeasureActual.CalendarYear;
            ...
            var performanceMeasureSubcategoryOptionName = performanceMeasureActual.PerformanceMeasureActualSubcategoryOptions?.FirstOrDefault(x => x.PerformanceMeasureActualID == performanceMeasureActual.PerformanceMeasureActualID)?.PerformanceMeasureSubcategoryOptionName ?? String.Empty;
