...
namespace ProjectFirma.Web.Common
{
    public static class FirmaValidationMessages
    {
       public static readonly string CompletionDateGreaterThanEqualToImplementationStartYear = $"{FieldDefinition.CompletionDate.GetFieldDefinitionLabel()} must be greater than or equal to the {FieldDefinition.ProjectInitiationDate.GetFieldDefinitionLabel()}.";
        ...
        public static readonly string FundSourceNoteIsEmptyText = $"{FieldDefinition.FundSourceNote.GetFieldDefinitionLabel()} is empty text. Please enter a note before saving.";
        public static readonly string FundSourceAllocationNoteIsEmptyText = $"{FieldDefinition.FundSourceAllocationNote.GetFieldDefinitionLabel()} is empty text. Please enter a note before saving.";
