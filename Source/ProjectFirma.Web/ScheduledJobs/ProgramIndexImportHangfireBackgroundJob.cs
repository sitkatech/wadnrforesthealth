...
namespace ProjectFirma.Web.ScheduledJobs
{
    public class ProgramIndexImportHangfireBackgroundJob : SocrataDataMartUpdateBackgroundJob
    {
        ...
        {
            if (DateTime.Compare(DateTime.Now, new DateTime(2020, 02, 04)) < 0)
            {
                Logger.Info($"We have some issues with Program Index data coming from the feed. Skipping job '{JobName}' until 2/4/2020");
                return;
            }
